...
The code found below can also be accessed through the [GEE](https://earthengine.google.com/) repository for
this study:
...
**Activity 1  [Moderate]**
Modify the general workflow presented to fit a SDM using presence-only data for the Plains zebra (**Equus quagga**). The data is available at the following asset:  `users/ramirocrego84/Perissodactyla`. Note that this includes other species, so you need to filter the data to retain only the Plains zebra data.
